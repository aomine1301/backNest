...
var MongoExceptionFilter = /** @class */ (function () {
    function MongoExceptionFilter() {
    }
    MongoExceptionFilter.prototype["catch"] = function (exception, host) {
